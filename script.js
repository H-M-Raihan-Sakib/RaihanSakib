...
document.getElementById('install_apk').addEventListener('click', function () {
  window.open(
    'https://drive.usercontent.google.com/download?id=1g5qv_4xo_3pWgUbWafSKMvUIjtpwBev2&export=download&authuser=0&confirm=t&uuid=f55b4eed-32ba-4527-b601-5d906835325b&at=AGN2oQ15tOkbGg6NCqA-MOoyg2xA:1775406334735',
    '_blank',
  );
});
...
form.addEventListener('submit', function (e) {
  ...
  emailjs
    .sendForm('service_l63a1dm', 'template_zjxztjp', form)
    .then(() => {
